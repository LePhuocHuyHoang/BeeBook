...
import com.example.sample.dto.PointTransactionDTO;
import com.example.sample.payloads.ApiResponse;
import com.example.sample.repositories.PointTransactionRepository;
...
public class PointTransactionServiceImpl implements PointTransactionService{
	...
	@Override
	public ResponseEntity<?> getAllPointTransaction(Long userId, Long offset, Long fetch) {
		List<Object[]> checkExistsUser = pointTransactionRepository.checkExistingUser(userId);
